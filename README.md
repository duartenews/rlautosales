# Northline Motors — Single-Page Used SUV Dealership

Premium, conversion-focused single-page experience for Northline Motors. Built with React, Vite, and Tailwind. All data is stored locally on the user device (localStorage) for now, with a storage abstraction ready to swap to an API later.
...
- Responsive, mobile-first UI with Montserrat/Inter typography and Northline palette
